exports.strings = {
  ...
  "git-error-rebase-squash-without-parent": {
    "__desc__": "Error for when user wants to make a squash on the child-most commit",
    "en_US": "Cannot 'squash' {commit} without a previous commit",
    "de_DE": "Kann '{commit}' nicht ohne einen vorherigen Commit 'squashen'",
    "zh_CN": "无法在没有前一个提交的情况下'squash' {commit}",
    "zh_TW": "無法在沒有前一個提交的情況下'squash' {commit}",
    "es_AR": "No se puede hacer 'squash' a {commit} sin un commit previo",
    "es_MX": "No se puede hacer 'squash' a {commit} sin un commit previo",
    "es_ES": "No se puede hacer 'squash' a {commit} sin un commit previo",
    "pt_BR": "Não é possível fazer 'squash' em {commit} sem um commit anterior",
    "gl": "Non se pode facer 'squash' en {commit} sen un commit previo",
    "fr_FR": "Impossible de 'squash' {commit} sans un commit précédent",
    "ro": "Nu se poate face 'squash' la {commit} fără un commit anterior",
    "ru_RU": "Невозможно выполнить 'squash' для {commit} без предыдущего коммита",
    "uk": "Неможливо виконати 'squash' для {commit} без попереднього коміту",
    "ko": "이전 커밋 없이 {commit}을(를) 'squash'할 수 없습니다",
    "vi": "Không thể 'squash' {commit} mà không có commit trước đó",
    "sl_SI": "Ni mogoče narediti 'squash' za {commit} brez prejšnjega commita",
    "pl": "Nie można wykonać 'squash' na {commit} bez poprzedniego commita",
    "it_IT": "Impossibile eseguire lo 'squash' di {commit} senza un commit precedente",
    "ta_IN": "முந்தைய கமிட் இல்லாமல் `{commit}` ஐ 'squash' ச,ய்ய முடியாது",
    "tr_TR": "Önceki bir commit olmadan {commit} 'squash' yapılamaz"
  },
  "git-result-nothing": {
